...
namespace WarCouncilModern.Initialization
{
    public class SubModule : MBSubModuleBase
    {
        ...
        protected override void OnGameStart(Game game, IGameStarter gameStarterObject)
        {
            ...
            ReflectionHelpers.TryAddSessionHandler(CampaignEvents.OnSessionLaunchedEvent, this, "OnSessionLaunched");
        }
        ...
        {
            // TODO: Fill with logic to initialize UI services or other session-specific setup.
